<template>
  <AppLayout title="Socios" subtitle="Gestión de socios y voluntarios">
    ...
    <div v-else class="bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div v-else-if="miembros.length === 0" class="p-12 text-center text-gray-500">
        ...
        <p class="text-lg">No se encontraron socios</p>
      ...
      <template v-else>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Socio</th>
